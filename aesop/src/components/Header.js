...
const Header = ()=>
{
    ...
    return(
        <>
            ...
            <div className='chat'>
                <button className='chat-btn'><i className="far fa-comment-alt fa-2x"></i></button>
            </div> 
